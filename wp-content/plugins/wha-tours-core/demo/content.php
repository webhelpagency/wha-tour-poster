...
return array(
	...
	'tours'      => array(
		...
		array(
			'key'       => 'seaside-camp-bulgaria',
			'title'     => 'Табір «Seaside Camp Bulgaria»',
			'excerpt'   => 'Морська зміна на Золотих Пісках: 15 днів моря, вихователів і програми Sunny Trails.',
			'content'   => "<!-- wp:paragraph -->\n<p>Морська зміна на Золотих Пісках: 15 днів моря, вихователів і програми Sunny Trails.</p>\n<!-- /wp:paragraph -->\n\n<!-- wp:paragraph -->\n<p>Маршрут: Золоті Піски, Болгарія. Керівник групи супроводжує дітей від виїзду до повернення.</p>\n<!-- /wp:paragraph -->",
			'category'  => 'camps',
			'seasons'   => array( 'summer' ),
		...
		array(
			'key'       => 'karpatskyi-spa',
			'title'     => 'Карпатський SPA-відпочинок (Закарпаття)',
	...
	'pages'      => array(
		...
		array(
			'key'     => 'pro-nas',
			'title'   => 'Про нас',
			'content' => "<!-- wp:paragraph -->\n<p>Sunny Trails — київський туроператор дитячого й молодіжного відпочинку. Автобусні тури Європою, екскурсії Україною, літні морські зміни. Кожна програма складена так, щоб дитина повернулась із враженнями, а вчитель чи батьки — без жодної зайвої турботи.</p>\n<!-- /wp:paragraph -->\n\n<!-- wp:paragraph -->\n<p>Працюємо з 1998 року. Знаємо, як провести групу через кордон, готель і музей без стресу. Морські зміни на Золотих Пісках — наші вихователі, наша програма, наш контроль.</p>\n<!-- /wp:paragraph -->",
			'image'   => 'budapest-chain-bridge.jpg',
		),
		array(
			'key'     => 'kontakty',
			'title'   => 'Контакти',
			'content' => "<!-- wp:paragraph -->\n<p>Туроператор дитячого та молодіжного відпочинку. Київ, з 1998 року.</p>\n<!-- /wp:paragraph -->\n\n<!-- wp:list -->\n<ul><li>Телефон: +38 000 000 00 00</li><li>E-mail: hello@example.com</li><li>Пн–Пт 9:00–18:00</li></ul>\n<!-- /wp:list -->",
	...
	/*
	 * Customizer settings of the WHA Tour Poster theme. They are only applied when
	 * that theme is active and the setting has not been given a value yet.
	 * `wha_tour_poster_about_page` is filled with the ID of the "Про нас" page.
	 */
	'theme_mods' => array(
		'wha_tour_poster_phone'         => '+38 000 000 00 00',
		'wha_tour_poster_cta_text'      => 'Підібрати програму',
		'wha_tour_poster_cta_url'       => '#contact',
		'wha_tour_poster_hero_eyebrow'  => 'Дитячий туроператор · з 1998',
		'wha_tour_poster_hero_title'    => 'Куди їдемо',
		'wha_tour_poster_hero_accent'   => 'на канікули?',
		'wha_tour_poster_hero_lead'     => 'Табори на морі, автобусні тури Європою, екскурсії Україною та пригодницькі маршрути для шкільних груп і сімей. Оберіть напрям, решту організуємо ми.',
		'wha_tour_poster_fact_1_number' => '28',
		'wha_tour_poster_fact_1_accent' => '.',
		'wha_tour_poster_fact_1_title'  => 'років дитячого туризму',
		'wha_tour_poster_fact_1_text'   => 'Працюємо з 1998 року. Знаємо, як провести групу через кордон, готель і музей без стресу.',
		'wha_tour_poster_fact_2_number' => '1',
		'wha_tour_poster_fact_2_accent' => ':1',
		'wha_tour_poster_fact_2_title'  => 'керівник групи від Sunny Trails',
		'wha_tour_poster_fact_2_text'   => 'Супроводжує від виїзду до повернення і щодня на зв’язку з батьками у спільному чаті.',
		'wha_tour_poster_fact_3_number' => '2018',
		'wha_tour_poster_fact_3_accent' => '',
		'wha_tour_poster_fact_3_title'  => '«Вибір року» — золота медаль',
		'wha_tour_poster_fact_3_text'   => 'У категорії дитячого відпочинку. Оцінка батьків, а не реклами.',
		'wha_tour_poster_fact_4_number' => '2',
		'wha_tour_poster_fact_4_accent' => '×',
		'wha_tour_poster_fact_4_title'  => 'морські зміни в Болгарії',
		'wha_tour_poster_fact_4_text'   => 'Морські зміни на Золотих Пісках — наші вихователі, наша програма, наш контроль.',
		'wha_tour_poster_stat_1_number' => '1998',
		'wha_tour_poster_stat_1_label'  => 'рік заснування',
		'wha_tour_poster_stat_2_number' => '39',
		'wha_tour_poster_stat_2_label'  => 'програм у каталозі',
		'wha_tour_poster_stat_3_number' => '12',
		'wha_tour_poster_stat_3_label'  => 'країн Європи',
		'wha_tour_poster_lead_heading'  => 'Розкажіть про групу — підберемо програму за день',
		'wha_tour_poster_lead_text'     => 'Скільки дітей, якого віку, коли канікули і який бюджет. Решту ми зробимо самі.',
		'wha_tour_poster_telegram'      => 'https://example.com/',
		'wha_tour_poster_viber'         => 'https://example.com/',
		'wha_tour_poster_facebook'      => 'https://example.com/',
		'wha_tour_poster_instagram'     => 'https://example.com/',
	),
