...
$elita_tour_title       = ( is_home() && ! is_front_page() ) ? single_post_title( '', false ) : '';

if ( '' === trim( (string) $elita_tour_title ) ) {
	$elita_tour_title = __( 'Latest posts', 'elita-tour' );
}
?>
		...
		<section class="section">
			<div class="container">
				...
				<div class="section__head">
					<div>
						<span class="eyebrow"><?php esc_html_e( 'Blog', 'elita-tour' ); ?></span>
