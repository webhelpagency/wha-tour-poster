		...
		<section class="section">
			<div class="container">
				...
				<div class="section__head">
					<div>
						<span class="eyebrow"><?php esc_html_e( 'Search', 'elita-tour' ); ?></span>
						<h1 class="page-title">
							<?php
							/* translators: %s: search query. */
							printf( esc_html__( 'Search Results for: %s', 'elita-tour' ), '<span>' . esc_html( get_search_query() ) . '</span>' );
							?>
						</h1>
					</div>
						...
						<?php if ( have_posts() ) : ?>
							...
							the_posts_pagination(
								array(
									...
									'screen_reader_text' => esc_html__( 'Search results navigation', 'elita-tour' ),
								)
							);
							?>
