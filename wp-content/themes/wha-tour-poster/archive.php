...
$wha_tour_poster_title       = get_the_archive_title();
$wha_tour_poster_description = get_the_archive_description();
?>
		...
		<section class="section">
			<div class="container">
				...
				<div class="section__head">
					<div>
						<span class="eyebrow"><?php esc_html_e( 'Archive', 'wha-tour-poster' ); ?></span>
						<h1 class="page-title"><?php echo wp_kses_post( $wha_tour_poster_title ); ?></h1>
