...
WHA Tour Poster is a poster-styled theme for a children's tour operator: the front page leads with
...
(such as the WHA Tours Core plugin), it renders poster cards and seasonal departures; otherwise
it falls back to standard posts and categories.

== Installation ==

1. In your WordPress admin, go to Appearance > Themes and click Add New.
2. Click Upload Theme and choose the wha-tour-poster.zip file, then click Install Now.
...
5. Go to Appearance > Customize > WHA Tour Poster to set the phone number, the call to action and
...
route, dates and price data is available (such as the one added by the WHA Tours Core plugin), the
...
WHA Tour Poster WordPress Theme, (C) 2026 Web Help Agency
WHA Tour Poster is distributed under the terms of the GNU GPL v2 or later.
